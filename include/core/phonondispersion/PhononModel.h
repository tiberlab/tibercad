...
class PhononModel: public PhysicalModel
{
 public:
  ...
  //  void get_free_dynamical_matrix(std::vector<std::vector< double > >& D);
   void get_free_dynamical_matrix(Tensor2Sym& dynamical_matrix);
   void get_full_dynamical_matrix(Tensor2Sym& dynamical_matrix);

   void get_raman_tensor(std::vector<Tensor2Sym> & raman_tensor);
