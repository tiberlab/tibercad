 ...
 * \li \c Hrecombination.some_name power density (s^{-1} \cdot cm^{-3}) generated by the non radiative recombination of model of model \c some_name
 * \li \c recombination.some_name the net recombination rate  (s^{-1} \cdot cm^{-3}) of model \c some_name
