 ...
 *  static PhysicalModel* create(const ModelOptions&)
 ...
 */
class PhysicalModel : public TiberModelObject
{
  ...
  public:
     ...
     */
    void init_alloy(const PhysicalModel* comp_A,
  ...
  protected:
    ...
    typedef std::multimap<std::string, PhysicalModel*> SubmodelMap;
     ...
     * \c create_submodels() methods or by calling directly PhysicalModel::create()
     ...
     */
    void add_submodel(const std::string& key, PhysicalModel* pm);
  ...
  private:
    ...
    //! Create a submodel
    void _create_submodel(PhysicalModel*& model, const std::string& type);
    ...
    //! Create submodels
    void _create_submodels(std::vector<PhysicalModel*>& models,
        const std::string& type);
...
inline
void
PhysicalModel::_set_type(const std::string& type)
{
  _type = type;
}
...
inline
void
PhysicalModel::_set_module_name(const std::string& module)
{
  _module = module;
}
...
inline
const std::string&
PhysicalModel::get_type(void) const
{
  return _type;
}
...
inline
double
PhysicalModel::alloy(double val_a, double val_b,
...
inline
ID
PhysicalModel::get_id(void) const
{
  return _id;
}
...
inline
ID
PhysicalModel::get_simulator_id(void) const
{
...
inline
void
PhysicalModel::set_simulator_id(ID id)
{
  _simulator_id = id;
}
...
inline
const Material*
PhysicalModel::get_material(void) const
{
...
PhysicalModel::get_owner(void) const
{
  return _owner;
}
...
inline
const std::string&
PhysicalModel::get_module_name(void) const
{
  return _module;
}
...
template <typename T>
T*
PhysicalModel::create_submodel_copy(const T* other) const
{
  assert(other != NULL);
...
template <typename T>
T*
PhysicalModel::create_submodel_alloy(const T* comp_A,
...
template <typename T>
T*
PhysicalModel::create(const std::string& name, const PhysicalObject* owner,
    const ModelOptions& options, const std::string& module)
{
  PhysicalModel* mod =
      PhysicalModel::_create(name, owner, options, module);
...
template <typename T>
T*
PhysicalModel::create(create_t create_fnc, destroy_t destroy_fnc,
        const PhysicalObject* owner,
        const ModelOptions& options,
        const std::string& module)
{
  PhysicalModel* mod =
      PhysicalModel::_create(create_fnc, destroy_fnc,
...
template <typename T>
void
PhysicalModel::create_submodel(T*& model, const std::string& type)
{
...
template <typename T>
void
PhysicalModel::create_submodels(std::vector<T*>& models,
    const std::string& type)
{
  std::vector<PhysicalModel*> mod;
...
inline
void
PhysicalModel::do_init_alloy(const PhysicalModel*,
    const PhysicalModel*, double)
{
}
...
inline
void
PhysicalModel::do_init_interface(const Material*,
    const Material*)
{
  do_init();
}
...
inline
void
PhysicalModel::do_reinit(const Elem*)
{
}
...
inline
PhysicalModel::SubmodelIterator
PhysicalModel::submodels_begin(void)
{
...
inline
PhysicalModel::SubmodelIterator
PhysicalModel::submodels_end(void)
{
...
inline
PhysicalModel::SubmodelIterator
PhysicalModel::submodels_begin(const std::string& name)
{
...
inline
PhysicalModel::SubmodelIterator
PhysicalModel::submodels_end(const std::string& name)
{
...
inline
PhysicalModel::ConstSubmodelIterator
PhysicalModel::submodels_begin(void) const
{
  return _submodels.begin();
}
...
inline
PhysicalModel::ConstSubmodelIterator
PhysicalModel::submodels_end(void) const
{
  return _submodels.end();
}
...
inline
PhysicalModel::ConstSubmodelIterator
PhysicalModel::submodels_begin(const std::string& name) const
{
  return _submodels.lower_bound(name);
}
...
inline
PhysicalModel::ConstSubmodelIterator
PhysicalModel::submodels_end(const std::string& name) const
{
  return _submodels.upper_bound(name);
}
