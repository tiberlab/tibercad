...
/** 2D Element Class. Contains Segment data and orientations. */
class ISE_Element_2D : public  ISE_Element
{
 public:

	
/** Constructor. Assigns Edge pointers and defines orientation vector. */
...
/** Orientation Check. If negative swaps nodes of element. */	
