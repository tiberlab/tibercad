...
Thermal module computes the balance between the heat generated and the heat dissi 
pated. Here we get the temperature profile of a rectangular device with an hotspot in
the center.
