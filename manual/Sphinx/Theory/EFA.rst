...
| ``ProbabilityDensity`` :math:`|\psi({\bf r})|^2` of the eigenstate wavefunction 
...
If  the  keyword QuantumDensity is  present in the plot list, the  electron quantum density is  calculated ::
