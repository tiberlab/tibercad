...
\begin{figure}
\includegraphics[width=8cm]{./figures/geomosfet.eps}

%\centerline{\psfig{figure=geomosfet.ps, angle = 270,width=9cm }}
...
\begin{figure}
\includegraphics[width=8cm]{./figures/meshmosfet.eps}
...
This time, for this simulation we declare two \textbf{driftdiffusion physical models}, respectively about \textbf{mobility} (\textit{field\_dependent}) and  \textbf{recombination} (\textit{srh});  see  the reference manual  for  the  details.
