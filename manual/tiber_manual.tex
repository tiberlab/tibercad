...
\clear
%\input{getting_started_1}
\clear
%input{getting_started_2}
\clear
%input{chapter_input_file}
\clear
%input{chapter_strain}
\clear
%input{../src/core/modules/elasticity/doc/elasticity}
\clear
%input{chapter_driftdiffusion}
\clear
%input{../src/core/modules/thermalbalance/doc/thermal}
\clear
%input{chapter_EFA}
\clear
