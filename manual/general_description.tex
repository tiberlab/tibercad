...
If  GMSH  program  is  used  to  model and  mesh  the  device,  a  bit  more  care  has  to  be  taken. Please see the GMSH user manual (\url{http://geuz.org/gmsh}) for  further  details. 
