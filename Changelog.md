...
New features and bug fixes:
	...
	- bug fixes in elasticity module, shape deformation is now working
	  correctly
...
New features:
	...
	- improved generation model for DSC based on Lambert-Beer
	  approximation
...
New features:
	...
	- self consistency Schroedinger-Poisson/Drift Diffusion,
	  based on predictor-corrector scheme with embracing region

	- physical models can be restricted to a subset of the simulation domain
	- string labels can be used in GMSH as physical region identifiers
	  instead of numbers
