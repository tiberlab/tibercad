...
/*!
 * \file ZbStrainDynamicalMatrix.h
...
#ifndef TC_ZB_FREESTRAINDYNAMICALMATRIX_H
#define TC_ZB_FREESTRAINDYNAMICALMATRIX_H
...
inline
PhysicalModel*  ZbStrainDynamicalMatrix::create_new (void) const
{
