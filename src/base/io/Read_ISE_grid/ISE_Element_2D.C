...
//vector<unsigned int> ISE_Element_2D::get_nodes()
//{
//	//cout <<  "  THERE" << endl;
...
//		{
//			current_node = (element_edges[i].get_vertex(j+1) )->get_node_id() ;
...
void ISE_Element_2D::set_element_nodes()
{
  ...
  //  check_orientation_2Dusing namespace  std;
...
//		}
//		
//		if (negative_edges[i] == truecoord.clear();)
//		{
//			//swap last  2  nodes !!!!!!!;
//			
//			cout << "element_nodes[last] =  " << element_nodes[last]<< endl;
//			cout << "element_nodes[last-1] =  "<<  element_nodes[last-1]<<  endl;
//			
//			last= (element_nodes.size() ) - 1;
//			swap(element_nodes[last], element_nodes[last-1]);
//			
...
//void  check_orientation_2D( vector<unsigned int>&  node_id_list,  unsigned  int type )
