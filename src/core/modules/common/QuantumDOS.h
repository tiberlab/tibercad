// $Id: QuantumDOS.h 3258 2012-04-03 15:10:22Z maufder $
...
class TBDLEXPORT QuantumDOS : public DensityOfStates
{
  ...
  protected:
    ...
    virtual void
    calculate_density_and_derivative(std::vector<double>& den_and_der, double Ef, double Epot, double kT, double kTlattice) const;
