...
class DriftDiffusionProperties : public PhysicalModel
{
  ...
  public:
    ...
    class PointData
    {
      public:
        ...
        double electron_density_derivativeG;
        ...
        double hole_density_derivativeG;
        ...
        double electron_recombination_rateHG;
        ...
        std::vector<double> electron_recombination_rate_derivativesHG;

        //! The net hole recombination rate
        double hole_recombination_rate;
        double hole_recombination_rateHG;
        ...
        std::vector<double> hole_recombination_rate_derivativesHG;
    ...
    void set_potentials(double potential, double Ef_e = 0.0, double Ef_h = 0.0,
        double Ef_eG = 0.0, double Ef_hG = 0.0);
    ...
    double get_electron_density_guest(void) const
      { return _pd->electron_densityG; };
    ...
    double get_electron_density_derivative_guest(void) const
      { return _pd->electron_density_derivativeG; };
    ...
    double get_hole_density_guest(void) const
      { return _pd->hole_densityG; };
    ...
    double get_hole_density_derivative_guest(void) const
      { return _pd->hole_density_derivativeG; };
     ...
     */
    void get_charge_density_derivatives(double derivatives[4]) const;
    ...
    double get_net_electron_recombination_rateHG(void) const
      { return _pd->electron_recombination_rateHG; };
    ...
    const std::vector<double>&
      get_net_electron_recombination_rate_derivativesHG(void) const
        { return _pd->electron_recombination_rate_derivativesHG; };
    ...
    double get_net_hole_recombination_rateHG(void) const
      { return _pd->hole_recombination_rateHG; };
    ...
    const std::vector<double>&
      get_net_hole_recombination_rate_derivativesHG(void) const
        { return _pd->hole_recombination_rate_derivativesHG; };
    ...
    double get_electron_conductivity_guest(void) const
      { return _pd->electron_conductivityG; };
    ...
    double get_hole_conductivity_guest(void) const
      { return _pd->hole_conductivityG; };
    ...
    double get_electron_electro_chemical_potential(void) const
      { return _pd->fermi_e; };
    double get_electron_electro_chemical_potential_guest(void) const
      { return _pd->fermi_eG; };
    ...
    double get_hole_electro_chemical_potential(void) const
      { return _pd->fermi_h; };
    double get_hole_electro_chemical_potential_guest(void) const
      { return _pd->fermi_hG; };
    ...
    //! Get the conduction band properties
    const BandProperties& get_conduction_band_guest(void) const
      { return *_conduction_band_guest; };


    //! Get the valence band properties
    const BandProperties& get_valence_band_guest(void) const
      { return *_valence_band_guest; };


    //! Get the conduction band properties
    BandProperties& get_conduction_band_guest(void)
      { return *_conduction_band_guest; };


    //! Get the valence band properties
    BandProperties& get_valence_band_guest(void)
      { return *_valence_band_guest; };
  ...
  protected:
    ...
    //! Get the conduction band properties as pointer
    void set_conduction_band_guest(BandProperties* cb);


    //! Get the valence band properties as pointer
    void set_valence_band_guest(BandProperties* vb);
  ...
  private:
    ...
    BandProperties* _conduction_band_guest;
    ...
    BandProperties* _valence_band_guest;
...
DriftDiffusionProperties::set_potentials(double potential, double Ef_e,
    double Ef_h, double Ef_eG, double Ef_hG)
{
...
DriftDiffusionProperties::get_charge_density(void) const
{
  long double dens =
      ...
      static_cast<long double>(_pd->hole_densityG) -
      static_cast<long double>(_pd->electron_density) -
      static_cast<long double>(_pd->electron_densityG) +
...
DriftDiffusionProperties::get_charge_density_derivatives(
    double derivatives[4]) const
{
  long double der0 =
      static_cast<long double>(get_electron_density_derivative())
      - static_cast<long double>(get_ionized_donor_density_derivative())
      + static_cast<long double>(_pd->ionized_traps_derivative[0]);

  long double der1 =
      - static_cast<long double>(get_hole_density_derivative())
      + static_cast<long double>(get_ionized_acceptor_density_derivative())
      + static_cast<long double>(_pd->ionized_traps_derivative[1]);

  long double der2 =
      static_cast<long double>(get_electron_density_derivative_guest());

  long double der3 =
      - static_cast<long double>(get_hole_density_derivative_guest());

  derivatives[0] = static_cast<double>(der0);
  derivatives[1] = static_cast<double>(der1);
  derivatives[2] = static_cast<double>(der2);
  derivatives[3] = static_cast<double>(der3);
