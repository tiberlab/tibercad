...
DriftDiffusionProperties::calculate_densities(void)
{
  ...
  pair<double, double> el0(cb.get_density_and_derivative(0.0, _pd->electric_potential));
  _pd->quasi_equilibrium_n = el0.first;
  ...
  pair<double, double> hl0(vb.get_density_and_derivative(0.0, _pd->electric_potential));
  _pd->quasi_equilibrium_p = hl0.first;
