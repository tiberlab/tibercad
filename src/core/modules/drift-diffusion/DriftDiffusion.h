...
class TBDLLOCAL DriftDiffusion : public SimulationInterface
{
  public:
    ...
    enum Solutions
    {
      ...
      ChargeDensity,    /*!< total charge density (el+hl) */
      ...
      Displacement,     /*!< total electric displacement */
  ...
  private:
    ...
    constexpr static double _penalty_value = 1; //1e56;
#else
    const static double _penalty_value = 1; //1e56;
#endif
