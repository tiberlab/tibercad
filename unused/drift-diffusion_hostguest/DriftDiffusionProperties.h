  ...
  public:
    ...
    class PointData
    {
      public:
        ...
        std::vector<double> old_electron_recombination_rate_derivatives;
    ...
    double get_quasi_equilibrium_n(void) const
      { return _pd->quasi_equilibrium_n; };
    ...
    double get_quasi_equilibrium_p(void) const
      { return _pd->quasi_equilibrium_p; };
